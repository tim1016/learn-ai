...
>
> **Last reviewed:** 2026-07-07 (Bot Control account-proof actionability update: the Fresh run form's not-proven Account Truth start blocker names the missing/stale evidence and links directly to Account Monitor's account reconciliation receipt action, while deploy-only staging remains available.)
