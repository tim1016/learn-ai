...
**Decision drivers:** persistent IBKR paper bot work (the retired plan is retained in Git history); shadow VWAP strategy roadmap; Angular bot control control surface.
...
- Git history — historical design-lock round (this ADR is Resolution 1).
