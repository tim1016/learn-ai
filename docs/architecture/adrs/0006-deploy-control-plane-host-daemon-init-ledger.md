...
**Related:** ADR 0001 (JSON/Parquet substrate), ADR 0003 (host-venv operational topology), ADR 0004 (instance-addressed operator control plane), ADR 0005 (engine-authored readiness & broker ownership), `CONTEXT.md`, the retired paper-deployment plan in Git history, and the operator-deploy-ux handoff (pruned 2026-07-04; Git history).
