...
**Related:** ADR 0002 (shadow per-instance namespace + no-submit invariant), ADR 0004 (instance-addressed control plane), `CONTEXT.md`, the retired paper-deployment plan in Git history, and `.claude/rules/numerical-rigor.md` (single source of truth).
