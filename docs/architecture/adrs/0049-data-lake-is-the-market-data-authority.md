...
**Provenance:** Decision ticket [#1831](https://github.com/tim1016/learn-ai/issues/1831), child of the Data Lake Enablement PRD [#1825](https://github.com/tim1016/learn-ai/issues/1825). HITL: standing required human acceptance; the user explicitly accepted this ADR on 2026-08-27.
...
**Vocabulary:** `CONTEXT.md` § "Data lake" — Data lake, Artifact, Catalog. Per ADR 0040 Decision 4.
