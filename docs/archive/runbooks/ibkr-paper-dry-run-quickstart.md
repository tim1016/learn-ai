...
> **Current authority:** `docs/bot-control-operator-manual.md` and ADR-0030.
> **Archived because:** Paper-bot operation is now documented through the current UI-first manual.
