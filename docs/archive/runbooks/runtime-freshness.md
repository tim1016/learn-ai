...
> **Current authority:** `docs/bot-control-operator-manual.md` and the backend-authored Bot Control surface.
> **Archived because:** Runtime remediation now belongs to the current UI-first operator manual.
