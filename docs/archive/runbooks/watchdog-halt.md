...
> **Current authority:** `docs/bot-control-operator-manual.md`, ADR-0026, and ADR-0030.
> **Archived because:** Watchdog recovery is now represented by the lifecycle and Account Desk controls.
