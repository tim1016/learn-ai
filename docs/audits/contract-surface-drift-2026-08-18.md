...
| Broker-v2 operator manual | `OPERATOR_COPY`, action registry, recovery action vocabulary | `(cd PythonDataService && python -m scripts.regenerate_broker_v2_operator_manual  # retired 2026-09-14; see docs/broker-clerk-fleet-authority.md)` | **Clean.** Canonical and served manuals are byte-identical. |
