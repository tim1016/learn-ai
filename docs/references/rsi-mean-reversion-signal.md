# RSI Mean Reversion — Signal Program promotion
...
- Program version: `rsi-mean-reversion/v1`
- Canonical implementation: `app/engine/strategy/algorithms/rsi_mean_reversion.py::RsiMeanReversionAlgorithm`
...
`PythonDataService/tests/fixtures/golden/rsi-mean-reversion-signal/v1/trace-corpus.json`
...
- Total traces: 35,900
- Corpus root: `46d0b13b5e3307d983b4d5b4a1a21ba790db5e5644d164364a787bb2a12acde7`
...
- Byte-regenerable:
  ...
  python -m scripts.generate_signal_program_trace_corpus \
    --program rsi_mean_reversion \
    --output tests/fixtures/golden/rsi-mean-reversion-signal/v1/trace-corpus.json --check
  ```
...
parameterized on `rsi_mean_reversion`:
