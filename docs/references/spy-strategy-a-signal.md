# Strategy A — EMA-gap + MACD + RSI-range — Signal Program promotion
...
- Program version: `spy-strategy-a/v1`
- Canonical implementation: `app/engine/strategy/algorithms/spy_strategy_a.py::SpyStrategyAAlgorithm`
...
`PythonDataService/tests/fixtures/golden/spy-strategy-a-signal/v1/trace-corpus.json`
...
- Total traces: 35,900
- Corpus root: `7ee88013046505a9df88fa9c83b94e1f5f4c4de92718dd874ca157b5eea25f5f`
...
- Byte-regenerable:
  ...
  python -m scripts.generate_signal_program_trace_corpus \
    --program spy_strategy_a \
    --output tests/fixtures/golden/spy-strategy-a-signal/v1/trace-corpus.json --check
  ```
...
parameterized on `spy_strategy_a`:
