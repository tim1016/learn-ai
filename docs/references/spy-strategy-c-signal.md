# Strategy C — ADX-rising + RSI-range — Signal Program promotion
...
- Program version: `spy-strategy-c/v1`
- Canonical implementation: `app/engine/strategy/algorithms/spy_strategy_c.py::SpyStrategyCAlgorithm (extends app/engine/strategy/algorithms/_rsi_range_base.py::RsiRangeStrategy)`
...
`PythonDataService/tests/fixtures/golden/spy-strategy-c-signal/v1/trace-corpus.json`
...
- Total traces: 35,900
- Corpus root: `9efc77718f0028e78ad6ea7d56ffda19a510cbba7f5ea3b5a6d5cccade6a75c6`
...
- Byte-regenerable:
  ...
  python -m scripts.generate_signal_program_trace_corpus \
    --program spy_strategy_c \
    --output tests/fixtures/golden/spy-strategy-c-signal/v1/trace-corpus.json --check
  ```
...
parameterized on `spy_strategy_c`:
