...
| `data_snapshot_id` | Pipe-joined string `f"{symbol}\|{resolution_minutes}\|{start_ms}\|{end_ms}\|{data_root_revision}"`. **Not** a content hash of bars (see "Why not bar-content addressing" below). |
