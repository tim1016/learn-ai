# Strategy B — Supertrend + ADX + MACD + RSI-range — Signal Program promotion
...
- Program version: `spy-strategy-b/v1`
- Canonical implementation: `app/engine/strategy/algorithms/spy_strategy_b.py::SpyStrategyBAlgorithm (entry/exit orchestration and shared RSI/ADX math in app/engine/strategy/algorithms/_rsi_range_base.py::RsiRangeStrategy)`
...
`PythonDataService/tests/fixtures/golden/spy-strategy-b-signal/v1/trace-corpus.json`
...
- Total traces: 35,900
- Corpus root: `775a5dfd4a98090111c4aa0f643f647b4b14cf27c9334ac266ebc9565b7485b4`
...
- Byte-regenerable:
  ...
  python -m scripts.generate_signal_program_trace_corpus \
    --program spy_strategy_b \
    --output tests/fixtures/golden/spy-strategy-b-signal/v1/trace-corpus.json --check
  ```
...
parameterized on `spy_strategy_b`:
