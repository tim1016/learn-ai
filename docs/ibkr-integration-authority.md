...
>
> **Last reviewed:** 2026-07-03 (Account Truth submit-gate update — account truth derives bot ownership from the durable account instance registry and its latest projection is cached for submit readiness and the live submit gate. Per-source freshness, Flex import, Client Portal cross-checks, and post-hoc manual adoption remain follow-up slices.).
