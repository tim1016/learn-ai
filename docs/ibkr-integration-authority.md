...
>
> **Last reviewed:** 2026-07-03 (Account Truth readiness-cache update — account truth derives bot ownership from the durable account instance registry and its latest projection is cached for read-side submit readiness. Hard pre-submit enforcement, Flex import, Client Portal cross-checks, and post-hoc manual adoption remain follow-up slices.).
