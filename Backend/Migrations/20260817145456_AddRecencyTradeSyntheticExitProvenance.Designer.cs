...
namespace Backend.Migrations
{
    ...
    [Migration("20260817145456_AddRecencyTradeSyntheticExitProvenance")]
    partial class AddRecencyTradeSyntheticExitProvenance
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Backend.Models.MarketData.RecencyTradeMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("RecencyTradeId", "RecencyRunId")
                        .IsUnique();

                    b.ToTable("RecencyTradeMemberships");
                });
            ...
            modelBuilder.Entity("Backend.Models.MarketData.RecencyTradeMembership", b =>
                {
                    ...
                    b.HasOne("Backend.Models.MarketData.RecencyTrade", "RecencyTrade")
                        .WithMany("Memberships")
                        .HasForeignKey("RecencyTradeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RecencyRun");

                    b.Navigation("RecencyTrade");
                });
