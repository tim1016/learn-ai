...
def _trade_to_open_order(
    ...
    *,
    ...
    filled_quantity = float(getattr(order, "filledQuantity", 0.0) or 0.0)
    cumulative_filled = float(getattr(status_obj, "filled", 0.0) or 0.0) or filled_quantity
    ...
    quantity = float(order.totalQuantity) or filled_quantity or cumulative_filled
