...
- :func:`accept_enter` — purely local. Commits the content-addressed
  ``(strategy_instance_id, decision_id)`` identity through
...
def accept_enter(
    ...
    *,
    ...
    def build_transition() -> TransitionInput:
        # See commands.py's submit_start_run for why this existence check
        # runs here, under commit_first_transition's lock, rather than
        # before it.
