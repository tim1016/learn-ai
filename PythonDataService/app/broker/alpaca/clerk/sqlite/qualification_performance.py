...
SMOKE_ADVERSARIAL_TESTS: tuple[str, ...] = (
    ...
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_succeeds_with_empty_runner_roster",
    ...
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_refuses_unscoped_bot_directory_symlink_before_resolving",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_refuses_symlinked_cutover_evidence_directory",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_scopes_runner_roster_to_the_cutover_account",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_uses_account_scoped_legacy_roster_for_pre_registry_bot",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_succeeds_when_only_another_account_has_a_runner_bot",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_refuses_registered_bot_with_missing_binding_evidence",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_succeeds_with_no_legacy_artifacts",
    ...
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_initialize_serializes_concurrent_attempts_for_one_account",
    ...
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_plan_refuses_a_missing_generation_one_mirror",
    "tests/broker/alpaca/clerk/sqlite/test_cutover.py::test_apply_rejects_changed_generation_one_mirror_before_activation",
