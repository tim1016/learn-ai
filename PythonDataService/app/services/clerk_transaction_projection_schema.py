...
CLERK_TRANSACTION_EVENTS = TableExpectation(
    ...
    columns=(
        ...
        ColumnExpectation("transaction_id", "character varying", False), ColumnExpectation("broker", "character varying", False), ColumnExpectation("account_id", "character varying", False), ColumnExpectation("journal_generation", "character varying", False),
...
CLERK_TRANSACTION_PROJECTION_CURSORS = TableExpectation(
    ...
    columns=(
        ...
        ColumnExpectation("last_byte_offset", "bigint", False), ColumnExpectation("last_journal_seq", "bigint", False), ColumnExpectation("journal_generation", "character varying", False),
