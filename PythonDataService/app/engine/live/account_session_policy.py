...
def write_account_live_feed_evidence(
    ...
    *,
    ...
    """Record a live engine's observed feed liveness for account actions."""
    ...
    atomic_write_pydantic_artifact(account_live_feed_evidence_path(artifacts_root, canonical_account_id), evidence)
    return evidence
