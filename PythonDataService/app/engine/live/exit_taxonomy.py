...
LIVENESS_UNPROVEN_REGISTRY_SOURCE = "host_daemon.boot_liveness_unproven"
CRASH_RETIRED_BINDING_SOURCES = frozenset({PROCESS_CRASHED_REGISTRY_SOURCE})
LIVENESS_UNPROVEN_RETIRED_BINDING_SOURCES = frozenset(
    {LIVENESS_UNPROVEN_REGISTRY_SOURCE}
)
RECOVERY_REQUIRED_RETIRED_BINDING_SOURCES = (
    CRASH_RETIRED_BINDING_SOURCES | LIVENESS_UNPROVEN_RETIRED_BINDING_SOURCES
)
