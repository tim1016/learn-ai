...
def orphaned_socket_notice(
    *,
    ...
    return OperatorNotice(
        ...
        resolution="Clears after the operator verifies the orphaned IBKR client session and reconciles broker orders and positions.",
        action=OperatorNoticeAction(
            kind="external_manual_check",
            label="Check IBKR sessions",
            target="ibkr_sessions",
        ),
