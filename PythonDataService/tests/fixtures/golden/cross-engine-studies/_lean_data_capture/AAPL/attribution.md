# AAPL 24-Month Minute Capture -- Attribution
...
- `equity/usa/minute/aapl/` -- 479 daily trade-bar ZIP files (`YYYYMMDD_trade.zip`)
- `equity/usa/factor_files/aapl.csv` -- LEAN factor file (split/dividend adjustment factors)
- `equity/usa/map_files/aapl.csv` -- LEAN ticker map file (corporate action renames)
- `equity/usa/daily/aapl.zip` -- LEAN daily OHLCV bars (derived from minute bars)
...
```text
de64c0845a91510d8f5937b97caeec8b5e8204e2e488029c521b658d01ad945d
```
