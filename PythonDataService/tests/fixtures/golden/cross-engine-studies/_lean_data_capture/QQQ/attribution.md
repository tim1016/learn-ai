# QQQ 24-Month Minute Capture -- Attribution
...
- `equity/usa/minute/qqq/` -- 479 daily trade-bar ZIP files (`YYYYMMDD_trade.zip`)
- `equity/usa/factor_files/qqq.csv` -- LEAN factor file (split/dividend adjustment factors)
- `equity/usa/map_files/qqq.csv` -- LEAN ticker map file (corporate action renames)
- `equity/usa/daily/qqq.zip` -- LEAN daily OHLCV bars (derived from minute bars)
