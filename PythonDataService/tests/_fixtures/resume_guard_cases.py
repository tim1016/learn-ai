...
GUARD_CASES: list[GuardCase] = [
    ...
    GuardCase(
        name="intent_running_resume_already_running",
        broker_safety=_SAFE,
        reconciliation=_RECON_OK,
        uncertain_intent=_INTENT_CLEAR,
        ...
        expected_reason_codes=(),
        expected_resume_enabled=False,
        expected_resume_codes=("ALREADY_RUNNING",),
        expected_pause_enabled=True,
        expected_stop_enabled=True,
    ),
    GuardCase(
        name="intent_stopped_resume_requires_redeploy",
        broker_safety=_SAFE,
        reconciliation=_RECON_OK,
        uncertain_intent=_INTENT_CLEAR,
        ...
        expected_reason_codes=(),
        expected_resume_enabled=False,
        expected_resume_codes=("STOPPED_REQUIRES_REDEPLOY",),
        expected_pause_enabled=False,
