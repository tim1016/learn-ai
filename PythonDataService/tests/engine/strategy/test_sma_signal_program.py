"""Golden-trace qualification test for the registry-backed SMA Signal Program.
...
def test_validated_sma_settings_corpus_has_a_pinned_trace_root() -> None:
    fixture = Path(__file__).resolve().parents[2] / "fixtures/golden/sma-crossover-signal/v1/trace-corpus.json"
