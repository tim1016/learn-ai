"""Golden-trace qualification test for the registry-backed Strategy A Signal Program.

Mirrors ``tests/engine/strategy/test_sma_signal_program.py::
...
def test_validated_spy_strategy_a_settings_corpus_has_a_pinned_trace_root() -> None:
    fixture = Path(__file__).resolve().parents[2] / "fixtures/golden/spy-strategy-a-signal/v1/trace-corpus.json"
    ...
    registration = _STRATEGY_REGISTRY["spy_strategy_a"]
