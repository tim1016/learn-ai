"""Golden-trace qualification test for the registry-backed Strategy B Signal Program.
...
def test_validated_spy_strategy_b_settings_corpus_has_a_pinned_trace_root() -> None:
    fixture = Path(__file__).resolve().parents[2] / "fixtures/golden/spy-strategy-b-signal/v1/trace-corpus.json"
    ...
    registration = _STRATEGY_REGISTRY["spy_strategy_b"]
