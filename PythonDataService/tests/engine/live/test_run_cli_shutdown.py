...
def test_cmd_start_shutdown_event_path_flattens_and_returns_zero(tmp_path: Path) -> None:
    """End-to-end: graceful shutdown flattens Clerk-owned exposure."""
    ...
    # The Clerk journal proves this run owns the account position, so graceful
    # shutdown must submit the corresponding flatten.
