...
def test_reassignment_is_blocked_against_a_drained_lane_until_2155_closes(
    fleet_service: FleetControlService, control_dir: Path, clock: FrozenClock
) -> None:
    """§7.1: restart-during-outage can resurrect a drained lane's binding, so
    no drained lane is reassigned — quiet and past-deadline notwithstanding."""
