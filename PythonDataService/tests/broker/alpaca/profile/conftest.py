...
Alpaca credential in a log grep. They are long, obviously-synthetic sentinels so
a containment assertion has something unmistakable to search for.
"""
...
DEFAULT_SLOT_KEY = "fixture-not-a-real-key-default-slot"
DEFAULT_SLOT_SECRET = "fixture-not-a-real-secret-default-slot"
LIVE_SLOT_KEY = "fixture-not-a-real-key-live-slot"
LIVE_SLOT_SECRET = "fixture-not-a-real-secret-live-slot"
ROTATED_LIVE_SLOT_SECRET = "fixture-not-a-real-secret-live-slot-rotated"
