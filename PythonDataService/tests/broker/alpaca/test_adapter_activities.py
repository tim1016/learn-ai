...
def test_trade_activity_maps_to_trade_category(load_alpaca_fixture) -> None:
...
def test_non_trade_activity_maps_to_non_trade_category(load_alpaca_fixture) -> None:
