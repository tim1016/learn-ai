...
- Cross-asset / cross-sectional validation — see
  [Cross-Sectional](https://github.com/tim1016/learn-ai/blob/master/Frontend/src/app/components/research-lab/batch-runner/)
...
Implemented in
[`signal/standardize.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/standardize.py).
...
[`signal/regime.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/regime.py).
...
Implemented in
[`research/target.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/target.py)
...
Implemented in
[`signal/backtest.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/backtest.py)
(`run_backtest`).
...
[`signal/diagnostics.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/diagnostics.py)
...
[`compute_sharpe_ci`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/diagnostics.py).
...
**Status:** implemented (Phase 1, 2026-04-30) —
[`compute_deflated_sharpe`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/diagnostics.py).
...
Implemented in
[`signal/walk_forward.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/walk_forward.py)
(`run_walk_forward`).
...
[`_compute_sharpe_trend_slope`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/walk_forward.py).
...
[`signal/graduation.py`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/graduation.py)
and is one of the four Stage 0 kill criteria (§ 5.1).

### 4.11 Effective trades per regime

**Status:** implemented (Phase 1, 2026-04-30) —
[`compute_joint_regime_coverage`](https://github.com/tim1016/learn-ai/blob/master/PythonDataService/app/research/signal/diagnostics.py).
