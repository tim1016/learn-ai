    ...
    const view = await render(AccountDeskRecoveryConfirmDialogComponent, {
      inputs: {
        confirmation: {
          ...
          consequence: 'Backend consequence.', confirmLabel: 'Accept exposure', requiredToken: '', providedToken: '', desiredAutomationEnabled: null, reason: '', journalCure: null, legacyCandidate: null, recoveryFlatten: null, presentedAction: null, emergencyOperationId: null, restoreOperationId: null,
        },
        busy: false,
        errorMessage: null,
      },
    ...
    const view = await render(AccountDeskRecoveryConfirmDialogComponent, {
      inputs: {
        confirmation: {
          ...
          consequence: 'Backend consequence.', confirmLabel: 'Run account reconcile', requiredToken: '', providedToken: '', desiredAutomationEnabled: null, reason: '', journalCure: null, legacyCandidate: null, recoveryFlatten: null, presentedAction: null, emergencyOperationId: null, restoreOperationId: null,
        },
        busy: false,
        errorMessage: null,
      },
  ...
  it('renders and accepts an exact backend-required confirmation token', async () => {
    const view = await render(AccountDeskRecoveryConfirmDialogComponent, {
      inputs: {
        confirmation: {
          command: 'reconcile', accountId: 'DU1234567', title: 'Run account reconciliation', body: 'Backend body.',
          consequence: 'Backend consequence.', confirmLabel: 'Run account reconcile', requiredToken: 'HALT', providedToken: 'HALT', desiredAutomationEnabled: null, reason: '', journalCure: null, legacyCandidate: null, recoveryFlatten: null, presentedAction: null, emergencyOperationId: null, restoreOperationId: null,
        },
        busy: false,
        errorMessage: null,
      },
