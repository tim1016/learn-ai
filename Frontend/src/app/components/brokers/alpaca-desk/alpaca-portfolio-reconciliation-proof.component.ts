...
@Component({
  ...
  imports: [AssetIdentityComponent, CurrencyPipe, DecimalPipe, TimestampDisplayComponent],
...
export class AlpacaPortfolioReconciliationProofComponent {
  ...
  trackAttribution = (_: number, row: PortfolioHistoryProof['attribution']['attribution_rows'][number]): string =>
