...
describe('SummaryStatsComponent', () => {
  ...
  it('should render stat cards when summary is provided', () => {
    fixture.componentRef.setInput('summary', createMockSummary());
    fixture.detectChanges();
  ...
  it('should apply positive class for positive price change', () => {
    fixture.componentRef.setInput('summary', createMockSummary({ priceChange: 5.0 }));
    fixture.detectChanges();
  ...
  it('should display period high and low', () => {
    fixture.componentRef.setInput('summary', createMockSummary({ periodHigh: 200, periodLow: 140 }));
    fixture.detectChanges();
