// PRD #617 — Playwright cockpit fixture builders.  Returns complete
...
export interface CockpitScenarioOptions {
...
export function buildScenarioStatus(opts: CockpitScenarioOptions) {
